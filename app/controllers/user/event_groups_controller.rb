class User::EventGroupsController < User::BaseController
  ...
  def create
    ...
    respond_to do |format|
      if @event_group.save
        format.html { redirect_to [:user, @event_group], notice: 'Event group was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @event_group.update(event_group_params)
        format.html { redirect_to [:user, @event_group], notice: 'Event group was successfully updated.' }
