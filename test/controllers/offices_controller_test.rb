...
class OfficesControllerTest < ActionController::TestCase
  ...
  test "should create office" do
    assert_difference('Office.count') do
      post :create, office: { address: @office.address, company_id: @office.company_id, email: @office.email, name: @office.name, phone: @office.phone }
    end
  ...
  test "should update office" do
    patch :update, id: @office, office: { address: @office.address, company_id: @office.company_id, email: @office.email, name: @office.name, phone: @office.phone }
    assert_redirected_to office_path(assigns(:office))
  end
